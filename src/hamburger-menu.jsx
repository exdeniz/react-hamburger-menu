...
export default function HamburgerMenu(props) {
  ...
  return (
    <div style={styles.container} onClick={props.menuClicked}>
      <span style={objectAssign({}, styles.lineBase, styles.firstLine)} />
      <span style={objectAssign({}, styles.lineBase, styles.secondLine)} />
      <span style={objectAssign({}, styles.lineBase, styles.thirdLine)} />
    </div>
  );
}
